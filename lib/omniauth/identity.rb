...
module OmniAuth
  ...
  module Identity
    ...
    autoload :Confirmable,         'omniauth/identity/confirmable'
    autoload :Recoverable,         'omniauth/identity/recoverable'
    autoload :Rememberable,        'omniauth/identity/rememberable'
    autoload :Trackable,           'omniauth/identity/trackable'
    module Models
